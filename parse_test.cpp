...
print x + y, z + n
  ...
  ASSERT_EQUAL(temp, "9 hello, world\n");
}
...
print program_name, origin, far_far_away, origin.SetX(1)
  ...
  tree->Execute(closure);
  std::string temp = os.str();
  ASSERT_EQUAL(temp, "Classes test (0; 0) (10000; 50000) None\n");
}
...
print r, c, t1, t2
  ...
  tree->Execute(closure);
  auto temp = os.str();
  ASSERT_EQUAL(temp, "Rect(10x20) Circle(52) Triangle(3, 4, 5) Wrong triangle\n");
}
